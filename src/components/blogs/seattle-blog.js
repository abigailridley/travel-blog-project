...
const SeattleBlog = () => {
    return ( 
        <div className="container seattle-blog">
            ...
            <p>
            On our flight, we sat next to a very talkative Welsh lady who now lives in Seattle with her Argentinian husband. She had a lot to say and wanted us to go and visit her while we were there. We never got her name or number. She told us not to go out at night in Seattle; this proved to be decent advice. We had heard horror stories of housesitters not being let in at customs because they considered house sitting to be work although we do not get paid. Under the instructions of Jon, who we are housesitting for in Portland; we lied. It worked, and we both headed to the train shaking in our boots yee-haw. 
